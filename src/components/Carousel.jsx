        ...
        <div class="carousel-item active" title="ir a Plantas exterior">
          <Link to={"/exterior"}>
            ...
            <div class="carousel-caption d-none d-md-block">
              ...
              <p>
                Esta planta en el sol, su color es casi negro, lo que provoca un
                bello contraste con otras plantas en un jardín. Por otro lado,
                en la sombra parcial llega a tomar un color púrpura con tonos
                verdes al centro.
              </p>
            </div>
          </Link>
        ...
        <div class="carousel-item" title="ir a Cactus">
          <Link to={"/cactus"}>
            ...
            <div class="carousel-caption d-none d-md-block">
              ...
              <p>
                Es una especie fanerógama perteneciente a la familia de las
                cactáceas, endémica de Paraguay y en Argentina, en las
                provincias de Formosa, Chaco y parte de Santiago del Estero, que
                actualmente se ha extendido por todo el mundo.
              </p>
            </div>
          </Link>
        </div>
        <div class="carousel-item" title="ir a Plantas interior">
          <Link to={"/interior"}>
            ...
            <div class="carousel-caption d-none d-md-block">
              <h5>Planta piedra</h5>
              <p>
                Este tipo de cactus es fascinante porque aunque parece una roca
                verde y no tiene hojas, le dará un aspecto muy diferente a tu
